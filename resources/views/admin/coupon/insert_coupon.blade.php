                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/insert-couponcode')}}" method="post">
                                    @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="coupon_code" class="form-control" id="exampleInputEmail1" required minlength="2" maxlength="10">
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Tính năng mã</label>
                                     <select name="coupon_condition" class="form-control input-sm m-bot15">
                                             <option value="2">----Chọn----- mặc-định-là-tiền---</option>
