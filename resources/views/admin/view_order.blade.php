        ...
        @foreach($order_details as $key => $details)
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td>
              ...
              <input  class="order_qty_{{$details->product_id}}" value="{{$details->product_sales_quantity}}" name="product_sales_quantity">
          ...
          <tr>
            <td colspan="6">
              @foreach($order as $key => $or)
                ...
                <form role="form" action="{{URL::to('/update-vieworder/'.$or->order_id)}}" method="post" enctype="multipart/form-data">
                                 {{csrf_field()}}
                  <select name= "order_status" class="form-control order_details">
                  ...
                  <button type="submit" name="add_delivery" class="btn btn-info ">Xác nhận </button>
                </form>
